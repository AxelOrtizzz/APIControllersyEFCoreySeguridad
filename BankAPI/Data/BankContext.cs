...
public partial class BankContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC270BABF2F5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC278AC370D5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Administ__3214EC277D4B5D69");

            entity.ToTable("Administrator");

            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.AdmiType)
                .HasMaxLength(30)
                .IsUnicode(false);
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC276D70D12D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC27A08E1B91");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC27FA674B47");
